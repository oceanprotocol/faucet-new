  ...
  var ht = 'collapse',
    ...
    gt = (function () {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          return (
            ((t = s({}, ft, t)).toggle = Boolean(t.toggle)), v(ht, t, dt), t
          )
        }),
      ...
      return (
        ...
        (e.show = function () {
          if (
            ...
            if (
              !V.trigger(this._element, 'show.bs.dropdown', i).defaultPrevented
            ) {
              if (!this._inNavbar) {
                if (void 0 === n.default)
                  throw new TypeError(
      ...
      return (
        ...
        (e._getConfig = function (t) {
          ...
          return (
            ...
            t.sanitize &&
              (t.template = jt(t.template, t.allowList, t.sanitizeFn)),
            t
          )
        }),
    ...
    ee = (function () {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          if (
            'string' !=
              typeof (t = s({}, Jt, 'object' == typeof t && t ? t : {}))
                .target &&
            m(t.target)
          ) {
            var e = t.target.id
